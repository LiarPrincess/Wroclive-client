...
enum Notification {
  ...
  var name: Foundation.Notification.Name {
    switch self {
    case .colorSchemeDidChange:           return Notification.name("pl.nopoint.wroclive.colorSchemeDidChange")
    case .vehicleLocationsDidUpdate:      return Notification.name("pl.nopoint.wroclive.vehicleLocationsDidUpdate")
    case .locationAuthorizationDidChange: return Notification.name("pl.nopoint.wroclive.locationAuthorizationDidChange")
