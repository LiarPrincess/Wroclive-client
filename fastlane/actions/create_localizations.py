...
print '// Run \'fastlane translate\' to generate it again.'
print '//'
print '//======================================================================='
print ''
print '// swiftlint:disable superfluous_disable_command'
print '// swiftlint:disable identifier_name'
...
print ''
print 'private class BundleHook { }'
print ''
print 'private func localizedString(_ key: String) -> String {'
print '  let bundle = Bundle(for: BundleHook.self)'
print '  return NSLocalizedString(key, bundle: bundle, comment: "")'
print '}'
print ''
