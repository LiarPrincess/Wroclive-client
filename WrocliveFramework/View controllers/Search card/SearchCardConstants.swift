...
public enum SearchCardConstants {
  public enum Layout {
    ...
    public static var height: CGFloat { return 0.9 * AppEnvironment.device.screenBounds.height }
    ...
    public enum Header {
      ...
      public enum Bookmark {
        ...
        public static let insets = UIEdgeInsets(top: 15.0, left: 6.0, bottom: 8.0, right: 16.0)
      }
