...
public enum BookmarksCardConstants {
  public enum Layout {
    ...
    public static var height: CGFloat { return 0.75 * AppEnvironment.device.screenBounds.height }
    ...
    public enum Header {
      ...
      public enum Edit {
        public static let insets = UIEdgeInsets(top: 20.0, left: Layout.rightInset, bottom: 4.0, right: Layout.rightInset)
      }
    }
  ...
  public enum TextStyles {
    ...
    public enum Edit {
      ...
      public static var done: TextAttributes { return TextAttributes(style: .bodyBold, color: .tint) }
    }
  }
}
