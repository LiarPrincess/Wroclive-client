...
public final class VehicleAnnotationUpdates {
  public typealias AnnotationAssignment = (vehicle: Vehicle, annotation: VehicleAnnotation)

  public var newAnnotations     = [VehicleAnnotation]()
  public var updatedAnnotations = [AnnotationAssignment]()
  public var removedAnnotations = [VehicleAnnotation]()
}

public enum VehicleAnnotationUpdater {

  public static func calculateUpdates(for annotations: [VehicleAnnotation], from vehicles: [Vehicle]) -> VehicleAnnotationUpdates {
