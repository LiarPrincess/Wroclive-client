...
public enum MapViewControllerConstants {
  ...
  public enum Pin {
    public static let imageSize:              CGSize       = CGSize(width: 50.0, height: 50.0)
    public static let minAngleChangeToRedraw: CGFloat      = 3.0
    public static let animationDuration:      TimeInterval = 1.5
  }

  public struct Defaults {
    public static let location = CLLocationCoordinate2D(latitude: 51.109_524, longitude: 17.032_564)
