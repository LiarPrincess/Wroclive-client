...
public typealias ConstraintMaker = (UIView, UIView) -> NSLayoutConstraint

extension UIView {
  public func addSubview(_ view: UIView, constraints: [ConstraintMaker]) {
    self.addSubview(view)
    self.addContraints(view, constraints: constraints)
  }

  public func insertSubview(_ view: UIView, aboveSubview siblingSubview: UIView, constraints: [ConstraintMaker]) {
    self.insertSubview(view, aboveSubview: siblingSubview)
    self.addContraints(view, constraints: constraints)
  }

  public func insertSubview(_ view: UIView, belowSubview siblingSubview: UIView, constraints: [ConstraintMaker]) {
...
public func makeEdgesEqualToSuperview() -> [ConstraintMaker] {
  return [
