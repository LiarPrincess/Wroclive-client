...
extension Localizable {
  ...
  public enum Locale: CustomStringConvertible {
    case base
    case en
    case pl
    ...
    private static var enLocale: Foundation.Locale?
    private static var plLocale: Foundation.Locale?

    private static var enBundle: Foundation.Bundle?
    ...
    fileprivate var locale: Foundation.Locale {
      ...
      case .en:
        let result = Self.enLocale ?? Foundation.Locale(identifier: "en")
        Self.enLocale = result
        return result
      case .pl:
    ...
    fileprivate var bundle: Bundle {
      ...
      case .en:
        let result = Self.enBundle ?? Self.createBundle(language: "Base")
        Self.enBundle = result
        return result
      case .pl:
