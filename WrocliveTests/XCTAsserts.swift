...
internal func XCTAssertEqual(_ lhs: ApiError?,
                             _ rhs: ApiError,
...
internal func XCTAssertEqual(_ lhs: CLLocationCoordinate2D,
...
internal func XCTAssertContains(_ vehicles: [Vehicle],
                               vehicle: Vehicle,
                               file: StaticString = #file,
                               line: UInt = #line) {
...
internal func XCTAssertContains(_ annotations: [VehicleAnnotation],
...
internal func XCTAssertContains(_ updates: [VehicleAnnotationDiff.Update],
